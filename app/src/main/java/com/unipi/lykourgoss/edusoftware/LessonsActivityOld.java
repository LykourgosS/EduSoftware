...
public class LessonsActivityOld extends AppCompatActivity implements View.OnClickListener {
    ...
    private FirebaseRecyclerAdapter<Lesson, LessonViewHolderOld> adapter;
...
//                createLessonDialog();
    ...
    /*private void loadListFromFirebase() {
        ...
        adapter = new FirebaseRecyclerAdapter<Lesson, LessonViewHolderOld>(options) {
            ...
            @Override
            protected void onBindViewHolder(@NonNull LessonViewHolderOld holder, int position, @NonNull final Lesson model) {
...
//                        loadClickListenerForParticipants(model.getMeetingId(), model.getName());
    ...
    private void createLessonDialog() {
        AlertDialog.Builder builder= new AlertDialog.Builder(LessonsActivityOld.this);

        //use create eduEntity dialog layout
        LayoutInflater inflater = LayoutInflater.from(LessonsActivityOld.this);
        ...
        buttonSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                lesson.create(LessonsActivityOld.this);
                dialog.cancel();
            }
        });
...
//
//        //Initialize the adapter
//        FirebaseRecyclerAdapter adapter = new FirebaseRecyclerAdapter<Lesson, LessonViewHolderOld>(options){
//
//            @NonNull
//            @Override
//            public LessonViewHolderOld onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
...
//
//            @Override
//            protected void onBindViewHolder(@NonNull LessonViewHolderOld holder, int position, @NonNull Lesson model) {
//
//            }
//        };
//
